if Code.ensure_compiled!(Credo) do
  defmodule Checks.RejectAny do
    @moduledoc """
      Checks all lines for a any(). This library uses term()
    """
    ...
    defp issue_for(issue_meta, line_no, trigger) do
      ...
      format_issue(issue_meta,
        message: "`any()` found in a spec, please use `term()`",
        line_no: line_no,
        trigger: trigger
      )
    end
